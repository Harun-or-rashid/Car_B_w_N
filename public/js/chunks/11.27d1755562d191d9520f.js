...
/* harmony import */ var _EmailLeftSidebar_vue__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./EmailLeftSidebar.vue */ "./resources/js/src/views/apps/email/EmailLeftSidebar.vue");
/* harmony import */ var _EmailView_vue__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./EmailView.vue */ "./resources/js/src/views/apps/email/EmailView.vue");
/* harmony import */ var _emailStoreModule__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./emailStoreModule */ "./resources/js/src/views/apps/email/emailStoreModule.js");
/* harmony import */ var _useEmail__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./useEmail */ "./resources/js/src/views/apps/email/useEmail.js");
/* harmony import */ var _EmailCompose_vue__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./EmailCompose.vue */ "./resources/js/src/views/apps/email/EmailCompose.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    BMediaBody: bootstrap_vue__WEBPACK_IMPORTED_MODULE_10__["BMediaBody"],
    ...
    // App SFC
    EmailLeftSidebar: _EmailLeftSidebar_vue__WEBPACK_IMPORTED_MODULE_15__["default"],
    EmailView: _EmailView_vue__WEBPACK_IMPORTED_MODULE_16__["default"],
    EmailCompose: _EmailCompose_vue__WEBPACK_IMPORTED_MODULE_19__["default"]
  },
  setup: function setup() {
    var EMAIL_APP_STORE_MODULE_NAME = 'app-email'; // Register module

    if (!_store__WEBPACK_IMPORTED_MODULE_8__["default"].hasModule(EMAIL_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_8__["default"].registerModule(EMAIL_APP_STORE_MODULE_NAME, _emailStoreModule__WEBPACK_IMPORTED_MODULE_17__["default"]); // UnRegister on leave

    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["onUnmounted"])(function () {
      if (_store__WEBPACK_IMPORTED_MODULE_8__["default"].hasModule(EMAIL_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_8__["default"].unregisterModule(EMAIL_APP_STORE_MODULE_NAME);
    });
    ...
    var _useEmail = Object(_useEmail__WEBPACK_IMPORTED_MODULE_18__["default"])(),
        resolveLabelColor = _useEmail.resolveLabelColor; // Route Params


    var routeParams = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["computed"])(function () {
      return route.value.params;
    });
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["watch"])(routeParams, function () {
      // eslint-disable-next-line no-use-before-define
      fetchEmails();
    }); // Emails & EmailsMeta

    var emails = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])([]);
    var emailsMeta = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])({});
    var perfectScrollbarSettings = {
      maxScrollbarLength: 150
    }; // Search Query

    var routeQuery = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["computed"])(function () {
      return route.value.query.q;
    });
    var searchQuery = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])(routeQuery.value);
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["watch"])(routeQuery, function (val) {
      searchQuery.value = val;
    }); // eslint-disable-next-line no-use-before-define

    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["watch"])(searchQuery, function () {
      return fetchEmails();
    });
    ...
    var fetchEmails = function fetchEmails() {
      _store__WEBPACK_IMPORTED_MODULE_8__["default"].dispatch('app-email/fetchEmails', {
        q: searchQuery.value,
    ...
    var selectedEmails = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])([]);
    ...
    var selectAllEmailCheckbox = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["computed"])(function () {
      return emails.value.length && emails.value.length === selectedEmails.value.length;
    });
    var isSelectAllEmailCheckboxIndeterminate = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["computed"])(function () {
    ...
    var toggleStarred = function toggleStarred(email) {
      _store__WEBPACK_IMPORTED_MODULE_8__["default"].dispatch('app-email/updateEmail', {
        emailIds: [email.id],
        dataToUpdate: {
    ...
    var updateSelectedEmailsLabel = function updateSelectedEmailsLabel(label) {
      _store__WEBPACK_IMPORTED_MODULE_8__["default"].dispatch('app-email/updateEmailLabels', {
        emailIds: selectedEmails.value,
        label: label
      }).then(function () {
        fetchEmails();
    ...
    var showEmailDetails = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])(false);
    var emailViewData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])({});
    var opendedEmailMeta = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["computed"])(function () {
    ...
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["watch"])([emailViewData, routeParams], function () {
      selectedEmails.value = [];
    }); // Compose

    var shallShowEmailComposeModal = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])(false); // Left Sidebar Responsiveness
    ...
    return {
      ...
      // UI Filters
      filterTags: _core_utils_filter__WEBPACK_IMPORTED_MODULE_12__["filterTags"],
      formatDateToMonthShort: _core_utils_filter__WEBPACK_IMPORTED_MODULE_12__["formatDateToMonthShort"],
      // useEmail
...
/* harmony import */ var _Applications_MAMP_htdocs_nvs_ll_wa_new_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/objectSpread2.js */ "./node_modules/@babel/runtime/helpers/esm/objectSpread2.js");
/* harmony import */ var _Applications_MAMP_htdocs_nvs_ll_wa_new_node_modules_babel_runtime_helpers_esm_typeof_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/typeof.js */ "./node_modules/@babel/runtime/helpers/esm/typeof.js");
...
var isObject = function isObject(obj) {
  return Object(_Applications_MAMP_htdocs_nvs_ll_wa_new_node_modules_babel_runtime_helpers_esm_typeof_js__WEBPACK_IMPORTED_MODULE_1__["default"])(obj) === 'object' && obj !== null;
};
...
var useRouter = function useRouter() {
  ...
  return Object(_Applications_MAMP_htdocs_nvs_ll_wa_new_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])(Object(_Applications_MAMP_htdocs_nvs_ll_wa_new_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])({}, Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["toRefs"])(state)), {}, {
    router: vm.$router
  });
};
/**
