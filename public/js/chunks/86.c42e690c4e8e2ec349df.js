...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Can't find stylesheet to import.\n   ╷\n18 │ @import 'scss/variables/variables'; // Bootstrap custom variable override (for user purpose)\r\n   │         ^^^^^^^^^^^^^^^^^^^^^^^^^^\n   ╵\n  resources/scss/base/bootstrap-extended/_include.scss 18:9                                   @import\n  resources/scss/vue/libs/vue-select.scss 4:9                                                 @import\n  resources/js/src/views/apps/calendar/calendar-event-handler/CalendarEventHandler.vue 403:9  root stylesheet");
...
module.exports = "/images/_/_/_/_/nvs-ll-wa_new/resources/js/src/assets/images/pages/calendar-illustration.png";
